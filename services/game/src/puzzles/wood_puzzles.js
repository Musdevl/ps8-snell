...
const puzzle_1 =
{
    initPuzzle: () => {
        ...
        board.setSlot(3, 8, black_first_protector)
...
const puzzle_2 =
{
    initPuzzle: () => {
        ...
        const white_triangle_1 = pieceService.createPiece(PIECE.TRIANGLE, COLORS.WHITE, DIRECTIONS.EAST)
        ...
        board.setSlot(2, 0, white_triangle_1);
