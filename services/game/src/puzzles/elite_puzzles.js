...
const puzzle_11 =
{
    initPuzzle: () => {
        ...
        return new Puzzle(11, "Tir décisif", game, puzzle_steps, hints, PUZZLE_DIFFICULTY.ELITE);
    }
}
...
const puzzle_12 =
{
    initPuzzle: () => {
        ...
        return new Puzzle(12, "Photon Master", game, puzzle_steps, hints, PUZZLE_DIFFICULTY.ELITE);
    }
}

export const elite_puzzles = [
